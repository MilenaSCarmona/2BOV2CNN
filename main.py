...
TRAIN_DATA_DIR = "../data/train" # Milena alteração de polen70e para ../polen70e devido mudança de local main.py 29/05/2018
VALIDATION_DATA_DIR = "../data/validation" # Milena alteração de val para ../val devido mudança de local main.py 29/05/2018
BATCH_SIZE = 16
EPOCHS = 60  # Milena alteração na epochs de 2mil para 50 29/05/2018
LEARNING_RATE = 0.0001
CLASS_NAMES = ['boca_fechada', 'boca_aberta'
]
...
def main():
    ...
    if args["fineTuningRate"] != -1:
        ...
        n_layers=len(model.layers) - int(len(model.layers) * (args["fineTuningRate"] / 100.)) # Geazy/Milena alteração com n_layers recebe len parametro 29/05/2018
        for layer in model.layers[:n_layers]: # Geazy/Milena alteração com insersão de n_layers 29/05/2018
